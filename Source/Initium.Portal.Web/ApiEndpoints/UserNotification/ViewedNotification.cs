...
{
    public class ViewedNotification : BaseAsyncEndpoint
        .WithRequest<ViewedNotification.EndpointRequest>
        .WithResponse<BasicEndpointResponse>
    {
        ...
        [HttpPost("api/user-notifications/view", Name = "ViewedNotificationEndpoint")]
