...
namespace Initium.Portal.Web.ODataEndpoints.Role
{
    ...
    public class RolesController : ODataController // : BaseODataController<Queries.Entities.RoleReadEntity, RoleFilter>
    {
        ...
        [HttpGet]
        public  IActionResult Filtered()//ODataQueryOptions<Queries.Entities.RoleReadEntity> options, [FromBody]RoleFilter filter)
        {
            return this.Ok(this._roleQueryService.QueryableEntity);
