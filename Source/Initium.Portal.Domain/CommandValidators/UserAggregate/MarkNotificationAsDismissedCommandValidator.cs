...
{
    public class MarkNotificationAsDismissedCommandValidator : AbstractValidator<MarkNotificationAsDismissedCommand>
    {
        public MarkNotificationAsDismissedCommandValidator()
        {
