...
namespace Initium.Portal.Tests.Domain.CommandHandlers.UserAggregate
{
    public class MarkAllUnreadNotificationsAsViewedCommandHandlerTests
    {
        ...
        public async Task Handle_GivenSavingFails_ExpectFailedResult()
        {
            ...
            var logger = new Mock<ILogger<MarkAllUnreadNotificationsAsViewedCommandHandler>>();

            var handler = new MarkAllUnreadNotificationsAsViewedCommandHandler(userRepository.Object, clock.Object, logger.Object);
